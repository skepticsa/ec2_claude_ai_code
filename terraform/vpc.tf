...
resource "aws_subnet" "public" {
  ...
  map_public_ip_on_launch = true # checkov:skip=CKV_AWS_130: Public subnets require public IP assignment for bastion access
...
resource "aws_s3_bucket_lifecycle_configuration" "flow_logs" {
  ...
  rule {
    ...
    filter {
      prefix = "" # Empty prefix to apply rule to all objects
    }
